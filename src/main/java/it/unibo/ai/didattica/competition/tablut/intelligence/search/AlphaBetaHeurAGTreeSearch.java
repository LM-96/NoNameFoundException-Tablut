 ...
 * This class use a {@link LeavesGenerator} in order to dynamically
 * generate the leaves of the nodes
 * @param <S> the type of the droplets of the leaves of the tree
 */
public class AlphaBetaHeurAGTreeSearch<S>
    extends AbstractHeurAGTreeSearch<S>
{
    public AlphaBetaHeurAGTreeSearch(HeuristicFunction<S> heuristic,
